...
class UserLoginView(LoginView):
    ...
    # сформирует страницу только тогда, когда пользователь запросит
    ...
    def form_valid(self, form):
        session_key = self.request.session.session_key #  получаем ключ
        ...
        if user:
            ...
            if session_key:
                ...
                messages.success(self.request, f'Добро пожаловать, {user.username}! Вы вошли в аккаунт!')
...
#                 messages.success(request, f'Добро пожаловать, {username}! Вы вошли в аккаунт!')
#
#                 if session_key:
#                     # delete old authorized user carts
#                     forgot_carts = Cart.objects.filter(user=user)
